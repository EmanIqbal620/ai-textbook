        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "This information is not available in the book." in response_text:
                    print("❌ UNEXPECTED: Got 'not found' response for query that should have an answer")
                else:
...
def main():
    ...
    print("\n" + "="*50)
    print("Summary:")
    print("✅ System prompt updated with strict rules")
    print("✅ Top-K retrieval set to 5")
    print("✅ Chunk size parameters updated (though existing content remains)")
    print("✅ System should now answer ONLY from book content")
